        ...
        for row in rows:
            ...
            items.append({
                ...
                'normalized': {
                    ...
                    'primary_size_native': float(row['primary_size_native']) if row.get('primary_size_native') is not None else None,
                    'primary_size_unit': row.get('primary_size_unit'),
                    'secondary_size_native': float(row['secondary_size_native']) if row.get('secondary_size_native') is not None else None,
